...
### [ClusterAPI](docs/sdks/clusterapi/README.md)

* [ClusterAPIListClusters](docs/sdks/clusterapi/README.md#clusterapilistclusters) - List Clusters
...
| # | Server | Variables |
| - | ------ | --------- |
| 0 | `http://192.168.100.172:31200` | None |
...
func main() {
	s := openapi.New(
		openapi.WithServerURL("http://192.168.100.172:31200"),
		openapi.WithSecurity("<YOUR_BEARER_TOKEN_HERE>"),
	)
